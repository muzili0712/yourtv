...
object SP {
    ...
    private const val KEY_USEX5WEBVIEW = "user_x5_webview"

    const val DEFAULT_USEX5WEBVIEW = false
    ...
    var useX5WebView: Boolean
        get() = sp.getBoolean(KEY_USEX5WEBVIEW, DEFAULT_USEX5WEBVIEW)
        set(value) = sp.edit().putBoolean(KEY_USEX5WEBVIEW, value).apply()
}